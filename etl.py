...
def populate_songplays_table(log_data_staging: DataFrame, songs_table: DataFrame, time_table: DataFrame) -> DataFrame:
    """
...
def populate_time_table(spark: SparkSession, log_data_staging: DataFrame) -> DataFrame:
    """
...
def populate_user_table(log_data_staging: DataFrame) -> DataFrame:
    """
...
def populate_log_staging_table(spark: SparkSession) -> DataFrame:
    """
